  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: project.backgroundColor || "#ffffff" }, children: [...project.tracks].reverse().map((track) => {
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Sequence,
      {
        ...
        layout: "none",
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(PrismLayer, { track, project, assets })
      },
      track.id
    );
  }) });
...
const PrismLayer = ({
  ...
  const entranceDuration = track.entranceDuration || track.transitionDuration || 30;
  const motionSpeed = track.motionSpeed || 90;
  const motionRepeat = track.motionRepeat ?? 0;
  let entOpacity = 1;
  let entScale = 1;
  let entX = 0;
  let entY = 0;
  let entRotate = 0;
  let entClipPath = void 0;
  if (entranceType) {
    const t = Math.min(frame, entranceDuration);
    if (entranceType === "fade_in") {
      entOpacity = (0,esm.interpolate)(t, [0, entranceDuration], [0, 1]);
    } else if (entranceType === "slide_in_left") {
      entX = (0,esm.interpolate)(t, [0, entranceDuration], [-width, 0], { easing: esm.Easing.out(esm.Easing.cubic) });
    } else if (entranceType === "slide_in_right") {
      entX = (0,esm.interpolate)(t, [0, entranceDuration], [width, 0], { easing: esm.Easing.out(esm.Easing.cubic) });
    } else if (entranceType === "slide_in_top") {
      entY = (0,esm.interpolate)(t, [0, entranceDuration], [-height, 0], { easing: esm.Easing.out(esm.Easing.cubic) });
    } else if (entranceType === "slide_in_bottom") {
      entY = (0,esm.interpolate)(t, [0, entranceDuration], [height, 0], { easing: esm.Easing.out(esm.Easing.cubic) });
    } else if (entranceType === "zoom_in") {
      entScale = (0,esm.interpolate)(t, [0, entranceDuration], [0, 1], { easing: esm.Easing.out(esm.Easing.cubic) });
      entOpacity = (0,esm.interpolate)(t, [0, Math.min(10, entranceDuration)], [0, 1]);
    } else if (entranceType === "zoom_out") {
      entScale = (0,esm.interpolate)(t, [0, entranceDuration], [1.5, 1], { easing: esm.Easing.out(esm.Easing.cubic) });
      entOpacity = (0,esm.interpolate)(t, [0, Math.min(10, entranceDuration)], [0, 1]);
    } else if (entranceType === "wipe_left") {
      const p = (0,esm.interpolate)(t, [0, entranceDuration], [100, 0], { easing: esm.Easing.out(esm.Easing.cubic) });
  ...
  if (motionType) {
    ...
    if (motionType === "ken_burns") {
      const kbProgress = (0,esm.interpolate)(frame, [0, duration], [0, 1], { extrapolateRight: "clamp" });
      motScale = 1 + kbProgress * 0.2;
    } else {
      ...
      if (frame < totalAllowedFrames) {
        ...
        cycleProgress = timeInCycle / motionSpeed;
        if (motionType === "pulse") {
          const val = Math.sin(cycleProgress * Math.PI);
          motScale = 1 + val * 0.05;
        } else if (motionType === "shake") {
          const val = Math.sin(cycleProgress * Math.PI * 4);
          motX = val * 5;
  ...
  const style = {
    ...
    borderStyle: borderWidth ? "solid" : void 0,
  ...
  if (type === "text") {
    if (isRasterized && assetId) {
      ...
      if (asset) {
        ...
        if (!finalSrc.startsWith("http") && !finalSrc.startsWith("file://") && !finalSrc.startsWith("blob:") && !finalSrc.startsWith("data:")) {
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      ...
      whiteSpace: "pre-wrap",
      // Preserves newlines from PSD
      lineHeight: 1.2,
      WebkitTextStrokeWidth: textStrokeWidth ? `${textStrokeWidth}px` : void 0,
  ...
  if (type === "image") {
    ...
    if (!asset) {
      ...
      return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { ...style, border: "2px dashed red" }, children: "Missing Asset" });
    }
    let finalSrc = asset.src;
    ...
    let content2 = /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "img",
      {
        src: finalSrc,
        style: {
    ...
    if (props.mask) {
      return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        ...
        borderRadius: props.mask.radius ? `${props.mask.radius}px` : void 0,
        overflow: "hidden",
        opacity,
        // Opacity usually applies to the whole group? Or just the layer? inheriting
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.Composition,
    {
      ...
      calculateMetadata: async ({ props }) => {
        ...
        let duration = (_a = props.project) == null ? void 0 : _a.durationInFrames;
        if (!duration && ((_c = (_b = props.project) == null ? void 0 : _b.tracks) == null ? void 0 : _c.length) > 0) {
          duration = Math.max(...props.project.tracks.map((t) => t.startFrame + t.durationInFrames));
        }
        return {
          durationInFrames: duration || 300,
          width: ((_d = props.project) == null ? void 0 : _d.width) || 1920,
          height: ((_e = props.project) == null ? void 0 : _e.height) || 1080,
          fps: ((_f = props.project) == null ? void 0 : _f.fps) || 30
        };
      }
    }
  );
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkprism"] = self["webpackChunkprism"] || [];
